...
def run_with_threads(tur, log, main_turtle):
    ...
    cir_thread = threading.Thread(target=draw_cir_thread)
    tri_thread = threading.Thread(target=draw_tri_thread)
    rect_thread = threading.Thread(target=draw_rect_thread)
